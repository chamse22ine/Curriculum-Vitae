                ...
                >
                    <div className="flex flex-col md:flex-row gap-8 items-center">
                        <div className="relative" ref={avatarRef} style={{ transform: "scale(0)" }}>
                            <div className="w-48 h-48 rounded-full bg-linear-to-br from-primary via-accent to-secondary p-1">
                                <div className="w-full h-full rounded-full bg-background flex items-center justify-center">
                                    <div className="w-44 h-44 rounded-full bg-linear-to-br from-primary/10 to-secondary/10 flex items-center justify-center text-6xl font-bold text-primary font-display">
                                        CA
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="flex-1 space-y-6 text-center md:text-left">
                            <h2 className="text-4xl md:text-5xl font-bold text-primary font-display">{t.about.title}</h2>
